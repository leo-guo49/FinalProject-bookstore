<?
	...
	if(isset($_GET['bookCatagory']) && $_GET['bookCatagory'] == '繪本')
	{
		$sql_query = "SELECT * FROM booklist WHERE bookCatagory = '繪本'";	
	}
	else if($_GET['bookCatagory'] == '拉拉書')
	{
		$sql_query = "SELECT * FROM booklist WHERE bookCatagory = '拉拉書'";
	}
	else if($_GET['bookCatagory'] == '食譜')
	{
		$sql_query = "SELECT * FROM booklist WHERE bookCatagory = '食譜'";
	}
	else if($_GET['bookCatagory'] == '童話')
	{	
		$sql_query = "SELECT * FROM booklist WHERE bookCatagory = '童話'";
	}
...
<header class="header">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(https://wallpaperaccess.com/full/124493.jpg)"></div>
